...
let score = scorer.calculate_score(&task_result)?;
```

### API Reference
- `QualityScorer::new(config)` - Creates new scorer
- `calculate_score(result)` - Calculates quality score
...
- [AI-Mining Guide](https://docs.tos.network/tutorials/ai-mining-optimization)
