...
def calculate_quarterly_burn(quarter_data):
    ...
    total_burn = transaction_burn + smart_contract_burn
...
|---------|------------|-----------|----------------|---------|
| **TOS Network** | 21M | PoW (BlockDAG) | ~36.5 days | 0% |
...
- **Diversified Mining**: Decentralized PoW mining
