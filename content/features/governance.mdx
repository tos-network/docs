...
const proposal = await governance.createProposal({
  ...
  title: "Increase Mining Reward Multiplier",
  description: `
    Proposal to increase mining reward multiplier from 1.1x to 1.3x
    to incentivize more mining participation and improve network
    decentralization.
  `,
  changes: {
    parameter: "mining_multiplier",
    currentValue: "1.1",
    proposedValue: "1.3"
  },
  stake: "10000.000000",
