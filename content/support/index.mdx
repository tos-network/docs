...
- **Discord**: [#emergency-support](https://discord.tos.network)
- **Email**: emergency@tos.network
- **Phone**: +1-555-TOS-HELP (24/7)

**Standard Support**:
- **Discord**: [#general-support](https://discord.tos.network)
...
**Discord Server**: [discord.tos.network](https://discord.tos.network)
...
- 💬 **Chat**: [Discord #support](https://discord.tos.network)
