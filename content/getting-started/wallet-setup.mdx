...
Mobile wallet is currently in development.
...
TOS Network will be listed on mainstream centralized exchanges (CEX) and decentralized exchanges (DEX) through community governance voting after mainnet launch.
...
3. **[Understand Energy Model](/features/energy-model)**
